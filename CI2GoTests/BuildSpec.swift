...
class BuildSpec: QuickSpec {
    override func spec() {
        let realm = try! Realm()
        sharedExamples("Mapped Build") { (sharedExampleContext: SharedExampleContext) in
        ...
        describe("Map Build from same JSON") {
            beforeEach {
        ...
        describe("Map Build from different JSON") {
            beforeEach {
        ...
        describe("getRecent") {
            ...
            it("resposes recent builds") {
                let builds = Build.getRecent().futureValue()!
        ...
        describe("getSteps") {
            ...
            it("imports build steps and actions") {
                let steps = build.getSteps().futureValue()!

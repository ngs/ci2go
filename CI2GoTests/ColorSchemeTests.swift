...
class ColorSchemeTests: XCTestCase {
  ...
  func testDictionary() {
    ...
    XCTAssertEqual(s.dictionary.keys.array, ["Selected Text Color", "Ansi 10 Color", "Background Color", "Ansi 4 Color", "Foreground Color", "Ansi 8 Color", "Ansi 2 Color", "Ansi 1 Color", "Ansi 11 Color", "Cursor Color", "Ansi 7 Color", "Ansi 3 Color", "Ansi 14 Color", "Ansi 0 Color", "Bold Color", "Ansi 6 Color", "Selection Color", "Ansi 9 Color", "Cursor Text Color", "Ansi 13 Color", "Ansi 5 Color", "Ansi 12 Color", "Ansi 15 Color"], "Has keys")
